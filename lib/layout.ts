...
export const statGridClass =
  "grid min-w-0 grid-cols-1 gap-3 overflow-visible py-1 sm:grid-cols-2 sm:gap-4 lg:grid-cols-4";
...
export const sceneIconClass = "size-20 shrink-0 sm:size-24 lg:size-28";
...
/** Segmented pill tabs — keep active fill inside the track. */
export const pillTabsListClass = cn(
  "inline-flex h-10 w-fit max-w-full items-center justify-start gap-0.5 overflow-hidden rounded-full bg-muted/50 p-1",
  "group-data-horizontal/tabs:h-10"
);

export const pillTabsTriggerClass = cn(
  "h-full min-h-0 flex-none rounded-full border-0 bg-transparent px-3.5 text-sm font-medium text-muted-foreground shadow-none",
